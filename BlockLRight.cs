...
namespace Tetris
{
    public class BlockLRight
    {
        ...
        public BlockLRight(int initialX, int initialY) //конструктор для линии которая будет появляться в начале каждого раунда
        {
            ...
            currentPosition[initialX + 2, initialY] = 3;
            currentPosition[initialX + 2, initialY + 1] = 4;
        ...
        public void MoveChange()
        {
            if (tipe == 0)
            {
                if (fourthPixelPosition[1] + 1 < currentPosition.GetLength(1))
                {
                    currentPosition[firstPixelPosition[0], firstPixelPosition[1]] = 0;
                    currentPosition[secondPixelPosition[0], secondPixelPosition[1]] = 0;
                    currentPosition[thirdPixelPosition[0], thirdPixelPosition[1]] = 0;
                    ...
                    currentPosition[firstPixelPosition[0] + 2, firstPixelPosition[1]] = 1;
                    currentPosition[secondPixelPosition[0] + 1, secondPixelPosition[1] + 1] = 2;
                    currentPosition[thirdPixelPosition[0], thirdPixelPosition[1] + 2] = 3;
                    currentPosition[fourthPixelPosition[0] - 1, fourthPixelPosition[1] + 1] = 4;
            ...
            else if(tipe == 1)
            {
                if (fourthPixelPosition[0] - 1 >= 0)
                {
                    ...
                    currentPosition[firstPixelPosition[0], firstPixelPosition[1] + 2] = 1;
                    currentPosition[secondPixelPosition[0] - 1, secondPixelPosition[1] + 1] = 2;
                    currentPosition[thirdPixelPosition[0] - 2, thirdPixelPosition[1]] = 3;
                    currentPosition[fourthPixelPosition[0] - 1, fourthPixelPosition[1] - 1] = 4;
            ...
            else if(tipe == 2)
            {
                ...
                currentPosition[firstPixelPosition[0] - 1, firstPixelPosition[1]] = 1;
                currentPosition[secondPixelPosition[0], secondPixelPosition[1] - 1] = 2;
                currentPosition[thirdPixelPosition[0] + 1, thirdPixelPosition[1] - 2] = 3;
                currentPosition[fourthPixelPosition[0] + 2, fourthPixelPosition[1] - 1] = 4;
            ...
            else
            {
                if (firstPixelPosition[0] - 1 >= 0)
                {
                    ...
                    currentPosition[firstPixelPosition[0] - 1, firstPixelPosition[1] - 2] = 1;
                    currentPosition[secondPixelPosition[0], secondPixelPosition[1] - 1] = 2;
                    currentPosition[thirdPixelPosition[0] + 1, thirdPixelPosition[1]] = 3;
                    currentPosition[fourthPixelPosition[0], fourthPixelPosition[1] + 1] = 4;
