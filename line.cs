...
namespace Tetris
{
    public class Line
    {
        ...
        public Line(int initialX, int initialY) //конструктор для линии которая будет появляться в начале каждого раунда
        {
            ...
            currentPosition[initialX + 3, initialY] = 4;
        ...
        public void MoveChange()
        {
            if (tipe == 0)
            {
                    ...
                    && thirdPixelPosition[1] + 1 < currentPosition.GetLength(1))
                {
                    ...
                    currentPosition[firstPixelPosition[0], firstPixelPosition[1] + 3] = 1;
                    currentPosition[secondPixelPosition[0] - 1, secondPixelPosition[1] + 2] = 2;
                    currentPosition[thirdPixelPosition[0] - 2, thirdPixelPosition[1] + 1] = 3;
                    currentPosition[fourthPixelPosition[0] - 3, fourthPixelPosition[1]] = 4;
